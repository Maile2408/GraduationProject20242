...
public class SawmillTask : BuildingTask
{
    ...
    {
        workerCtrl.workerMovement.SetWorkingType(true, WorkingType.sawing);
        ...
        workerCtrl.workerMovement.SetWorkingType(false, WorkingType.sawing);
    ...
    {
        ResHolder plank= this.buildingCtrl.warehouse.GetResource(ResourceName.plank);
        return plank.IsMax();
    }
