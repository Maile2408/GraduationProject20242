...
public class SawmillTask : BuildingTask
{
    ...
    IEnumerator Sawing(WorkerCtrl workerCtrl)
    {
        ...
        this.buildingCtrl.warehouse.AddResource(ResourceName.plank, this.blankReceive);
    ...
    {
        ResHolder blank= this.buildingCtrl.warehouse.GetResource(ResourceName.plank);
        return blank.IsMax();
    }
