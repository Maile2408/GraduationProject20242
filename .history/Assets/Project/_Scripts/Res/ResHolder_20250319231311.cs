...
public class ResHolder
{
    ...
    public ResHolder(ResourceName resource, float maxCapacity)
    {
        ...
        this.resCurrent = 0;
        this.resMax = Mathf.Max(0, maxCapacity); // Không cho phép giá trị âm
    }
    ...
    public float Add(float amount)
    {
        ...
        return addAmount; // Trả về số lượng thực tế đã thêm
    }
    ...
    public float Deduct(float amount)
    {
        ...
        return deductAmount; // Trả về số lượng thực tế đã trừ
    }
